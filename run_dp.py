...
print("Start training Dependency Parsing model")
...
train_data, test_data, train_iter, test_iter, TEXT, LABEL = get_data('train_dp.csv','test_dp.csv' )
...
for epoch in range(20):
    ...
    if epoch%1==0:
        ...
        torch.save(model, 'pos.pt')

print("Saving model for Dependency Parsing")
